...
# Default channel for broadcasts (set your channel here)
# Examples: "@mychannel" or "-1001234567890" 
DEFAULT_CHANNEL="@tradingbot_pnl"
...
case "$MSG_LOWER" in
  ...
  "📢 post to channel"*)
    ...
    if [ -n "$MSG_CONTENT" ]; then
        ...
        send_msg "📢 CHANNEL BROADCAST\n\nDefault channel: <code>$DEFAULT_CHANNEL</code>\n\nType your message after the button:\n• 📢 Post to Channel Your message here\n\nOr use:\n• post Your message here\n• post @other_channel Message" ""
    fi
